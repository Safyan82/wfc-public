...
import { getSiteGroupPayTableQuery } from '../../../util/query/siteGroup.query';
import { UpsertSiteGroupPayTableMutation } from '../../../util/mutation/siteGroup.mutation';
...
export const SiteGroupPayTable = ({id})=>{
    ...
    const {data: siteGroupPayTableData, loading: siteGroupPayTableLoading} = useQuery(getSiteGroupPayTableQuery,{
      variables:{
        sitegroupId: id
      },
      fetchPolicy:'network-only'
    ...
    },[payLevel, siteGroupPayTableData?.getSiteGroupPayTable?.response]);
    ...
    return(
        <div style={{padding:'12px 16px'}}>
            ...
            <div className="text">
                This is the site group pay table that will be use if there's no pay set in site.
            </div>
