...
import { getSiteGroups } from '../../util/query/siteGroup.query';

export const SiteFormDrawer = ({ objectLoading, 
  objectData, 
  visible, 
  onClose, 
                ...
                {schemaProperties?.map((property)=>{
                  ...
                  return(
                    ...
                    property?.propertyDetail?.label.toLowerCase()=="branch"?
                        ...
                        <Form.Item>
                            ...
                            >
                                ...
                                localGroup?.length && localGroup?.map((gl)=>(
                                    <Option value={gl._id}>{gl.branchname}</Option>
                                ))
                                }
                            </Select>
                        ...
                        :
                        property?.propertyDetail?.label.toLowerCase()=="customer"?
                          ...
                          : 
                        property?.propertyDetail?.label.toLowerCase().replaceAll(" ","")=="sitegroup"?
